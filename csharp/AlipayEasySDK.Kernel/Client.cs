...
namespace Alipay.EasySDK.Kernel;
    ...
    public class Client
    {
            ...
            Dictionary<string, object> bizParams, Dictionary<string, string> textParams)
        {
            ...
            IDictionary<string, string> sortedMap =
                new SortedDictionary<string, string>(systemParams, StringComparer.Ordinal);
        ...
        {
            if (GetConfig(AlipayConstants.NOTIFY_URL_CONFIG_KEY) != null &&
                !paramters.ContainsKey(AlipayConstants.NOTIFY_URL_FIELD))
            {
        ...
        public Stream ToMultipartRequestBody(Dictionary<string, string> textParams,
            Dictionary<string, string> fileParams, string boundary)
        {
        ...
        public Dictionary<string, object> ReadAsJson(TeaResponse response, string method)
        {
            ...
            Dictionary<string, object> dictionary =
                JsonConvert.DeserializeObject<Dictionary<string, object>>(responseBody);
        ...
        public string GeneratePage(string method, Dictionary<string, string> systemParams,
        ...
        {
            return GetConfig(AlipayConstants.PROTOCOL_CONFIG_KEY) + "://" + GetConfig(AlipayConstants.HOST_CONFIG_KEY) +
                   "/gateway.do";
        }
